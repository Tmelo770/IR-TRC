...
The repository contains several scripts that support the analysis of temporal rich-club (TRC) phenomena and the evolution of international trade networks:
P_birth.py and S&P1.py: Calculate the network evolution rates.
Random_t.py: Generate randomized reference networks for comparison and robustness analysis.
Uk_Comparian.py: Evaluate whether a temporal rich-club effect exists (u > 1).
x_feature.py and y1_feature.py: Extract structural features from trade networks, including degree-related and connectivity-based indicators.
Z-score.py: Standardize and centralize extracted features using Z-score normalization.
